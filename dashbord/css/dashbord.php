...
<head>
   ...
   <meta name="robots" content="noindex, nofollow">
	...
	<title><?php echo $ladministrateur["prenom"]?> - Tableau de bord - BICEC CRESCO</title>
					  ...
					  <div id="conteneur-page">
						  ...
						  <div class="wrap-bloc-page" id="bloc-graphe" >
							  ...
							  <ul class="wrap-onglet-graphe">
                                ...
                                <?php }else{?>
							  	<li class="onglet-graphe actif" data-id="bloc-graphe-semaine-agence">Semaine</li>
							  ...
							  <?php }else{?>
							  <div class="bloc-page  bloc-graphe  bloc-graphe-semaine box-shaldow" style="display: block" id="bloc-graphe-semaine-agence">
						  ...
						  <div class="wrap-bloc-page" id="bloc-chiffre-stat" >
							  ...
							  <div class="wrap-list-bloc">
								  ...
								  <div class="bloc-page box-shaldow wrap-bloc-chiffre">
									  <div class="bloc-chiffre">
										  <div class="info-bloc-chiffre">
											  <h4 class="valeur-bloc-chiffre"><?php echo GetNombreDossierParIndicateur("All", $niveau_dacces, $circonscription)?></h4>
								  ...
								  <div class="bloc-page box-shaldow wrap-bloc-chiffre">
									  <div class="bloc-chiffre">
										  <div class="info-bloc-chiffre">
											  <h4 class="valeur-bloc-chiffre"><?php echo GetNombreDossierParIndicateur("Incomplet", $niveau_dacces, $circonscription)?></h4>
								  ...
								  <div class="bloc-page box-shaldow wrap-bloc-chiffre">
									  <div class="bloc-chiffre">
										  <div class="info-bloc-chiffre">
											  <h4 class="valeur-bloc-chiffre"><?php echo GetNombreDossierParIndicateur("En_attente", $niveau_dacces, $circonscription)?></h4>
								  ...
								  <div class="bloc-page box-shaldow wrap-bloc-chiffre">
									  <div class="bloc-chiffre">
										  <div class="info-bloc-chiffre">
											  <h4 class="valeur-bloc-chiffre"><?php echo GetNombreDossierParIndicateur("En_cours", $niveau_dacces, $circonscription)?></h4>
											  <h6 class="libele-bloc-chiffre">En cours de traitement</h6>
										  </div>
										  <div class="img-bloc-chiffre"> <i class="fa fa-files-o"></i></div>
									  </div>
								  ...
								  <div class="bloc-page box-shaldow wrap-bloc-chiffre">
									  <div class="bloc-chiffre">
										  <div class="info-bloc-chiffre">
											  <h4 class="valeur-bloc-chiffre"><?php echo GetNombreDossierParIndicateur("Valide", $niveau_dacces, $circonscription)?></h4>
								  ...
								  <div class="bloc-page box-shaldow wrap-bloc-chiffre">
									  <div class="bloc-chiffre">
										  <div class="info-bloc-chiffre">
											  <h4 class="valeur-bloc-chiffre"><?php echo GetNombreDossierParIndicateur("Refuse", $niveau_dacces, $circonscription)?></h4>
											  <h6 class="libele-bloc-chiffre">Refus&eacute;s</h6>
										  </div>
										  <div class="img-bloc-chiffre"><i class="fa fa-files-o"></i></div>
									  </div>
									  <div class="wrap-evolution-chiffre">
        ...
        <?php if($niveau_dacces!="agence"){?>
						<table id="datatable-bref">
							...
							<tbody>
								<tr>
								    <th>Incomplets</th>
									<th><?php echo GetNombreDossierParIndicateur("Incomplet", $niveau_dacces, $circonscription)?></th>
								</tr>
								<tr>
								    <th>En attente</th>
									<th><?php echo GetNombreDossierParIndicateur("En_attente", $niveau_dacces, $circonscription)?></th>
								</tr>
								<tr>
								    <th>En cours de traitement</th>
									<th><?php echo GetNombreDossierParIndicateur("En_cours", $niveau_dacces, $circonscription)?></th>
								</tr>
								<tr>
								    <th>Validés</th>
									<th><?php echo GetNombreDossierParIndicateur("valide", $niveau_dacces, $circonscription)?></th>
								</tr>
								<tr>
								    <th>Refusés</th>
									<th><?php echo GetNombreDossierParIndicateur("refuse", $niveau_dacces, $circonscription)?></th>
								</tr>
							</tbody>
						...
						<table id="datatable">
							...
							<tbody>
							   <?php 
								...
								if($niveau_dacces=="region")$query_agence.=" AND idregion='$circonscription'";
	...
	<script src="//cdnjs.cloudflare.com/ajax/libs/multiple-select/1.2.2/multiple-select.min.js"></script>
		...
		;		  $(".bloc-graphe").css({'display':'none'});
				...
				$('#select').multipleSelect({
				  ...
				  countSelected : '# of % selectionn&eacute;(s)',

				  allSelected : 'Tout a &eacute;t&eacute; selection&eacute;'
