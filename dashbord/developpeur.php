...
?>	
		...
		<head>
			...
			<title>Module d&eacute;v&eacute;loppeur</title>
				...
				<div id="wrap-section-right">
					  <div id="section-right">
						  <div id="wrap-entete-page">
							  <h1 id="title-page">D&eacute;veloppeur</h1>
							  <ul id="fil-arian">
								  <li><a href="./"><i class="fa fa-home"></i></a>
								  </li>
								  <li><a href="">D&eacute;veloppeur</a>
								  </li>
							  </ul>
						  </div>

						<ul id="conteneur-onglet-page">
							<li class="onglet-page actif" data-id="tab-module">Gestion des modules</li>
							<li class="onglet-page" data-id="tab-menu">Gestion des menus</li>
							<li class="onglet-page" data-id="tab-smenu">Gestion des sous menus</li>
						</ul>
						...
						<div id="wrap-content-right">
							...
							<div id="conteneur-page">
								...
								<?php include("includes/onglet-module.php"); ?>
								
								
								<!--			RUBRIQUE DE GESTION DES GENRES					-->
								<?php //include("includes/onglet-menu.php"); ?>	
								
								
								<!--			RUBRIQUE DE GESTION DES GENRES					-->
								<?php //include("includes/onglet-smenu.php"); ?>
