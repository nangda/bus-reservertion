								<div class="wrap-contain-onglet-page" id="tab-dossier" <?php if((isset($_SESSION["onglet-suivi"]) AND $_SESSION["onglet-suivi"]=="tab-dossier") OR !isset($_SESSION["onglet-suivi"])){?>style="display: block"<?php }?>>

									<div class="contain-onglet-page">

										<h2 class="titre-tab">tous les dossiers</h2>
										...
										<div id="wrap-table-adhesion" class="conteneur-wrap-tab">
											...
											<div class="contain-tab2" id="tab-adhesion" style="display: block">
												...
												<h2 class="titre-page">
													...
													<div class="wrap-btn-plus-tab" style="margin-bottom: 20px">
												...
												<div class="wrap-content-page">
													...
													<p class="accroche-tab">Liste de toutes les demandes de cr&eacute;dit</p>

														<div class="conteneur-recherche-fiche">
														  <form action="" id="form-recherche-tous-dossiers" class="formulaire-research form-recherche">
															  ...
															  <div class="form-group">
															  	...
															  	<button type="button" class="btn-search valide-form-search" onClick="Rechercher('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-recherche-tous-dossiers','liste-tous-dossiers','loader')"><i class="fa fa-search"></i></button>
                                                                <input type="hidden" name="token" id="token" value="<?php echo $_SESSION["token"] ?>"/>
                                                                <input type="hidden" name="form" id="form" value="form-recherche-tous-dossiers"/>
                                                                <input type="hidden" name="etat-dossier" id="etat-dossier" value="tous"/>
                                                                <input type="hidden" name="conteneur-resultat" id="conteneur-resultat" value="liste-tous-dossiers"/>
															  </div>
												...
												<?php 
												  ...
												  while($demandeur=mysql_fetch_array($result_demandeur)){
													  ...
													  $clotureur= getadministrateurinformations($demandeur["cloture_par"]);
															...
															if($droit_dacces["editer_reponse_demande"]==1)$url_suivi="javascript:Affichage_contenuLightBox64('". base64_encode("lightbox/main.php?iddemandeur=$demandeur[0]&traitement=suivi-dossier")."','loader');";
												 ...
												 ?>
															<tr id="tr_dossier1">															
																...
																<td class="colonne-tab detail-line attach"><a href="<?php echo $url_justif?>" data-tooltip="<?php if(LeDossierDemandeurNaAucuneJustif($demandeur[0])==0) echo "Aucune pièce justificative"; else echo"Voir les pièces justificatives "?>" ><i class="fa fa-files-o"></i></a></td>	
																															
																<td class="colonne-tab edit-line"><a href="<?php echo $url_suivi?>" data-tooltip="Ecrire à <?php echo $demandeur["nom"]." ".$demandeur["prenom"]?>"><i class="fa fa-comments-o"></i></a>
																</td>
                                                                ...
                                                                <?php }else{?>
																<td class="colonne-tab fermeture-dossier cloture" id="td-cloture-tout<?php echo $demandeur[0]?>"><a href="<?php echo $url_cloturer?>" data-tooltip="Dossier cl&ocirc;tur&eacute; par <?php echo $clotureur["nom"]." ".$clotureur["prenom"]?> "><i class="fa fa-lock"></i></a></td>
                                                                <?php }?>
														...
														<div class="pagination">
															...
															<div class="wrapper-pagination-right">
																...
																<?php if ($nb_enregistrement>$page){ ?>
																    <!--<a href="" class="wrap-pagination">D&eacute;but</a>
																    ...
																    ?>
																		<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-recherche-tous-dossiers','liste-tous-dossiers','<? echo $i ?>','loader')" class="wrap-pagination <?php echo $active?>"><?php echo $i?></a> 
																	<?php }?>
																	<?php if($nbpage>$nbpage_affiche){?>
																<span class="void-pagination">...</span>
																   <?php }?>
																<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-recherche-tous-dossiers','liste-tous-dossiers','<? echo $page_active+1 ?>','loader')" class="wrap-pagination"><i class="fa fa-angle-right"></i> </a>
																<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-recherche-tous-dossiers','liste-tous-dossiers','<? echo $nbpage ?>','loader')" class="wrap-pagination">Fin</a>
																<?php }?>																
...
<script language="javascript">
		function getIdLastElement(element){
			 return ($("."+element).last().attr("id"));
		}</script>
