...
<table width="570" align="center">
  ...
  <tr>
    <td><div class="" style="width: 570px; height: auto; background-color: #FFFFFF; padding: 10px 0px 0px 0px; margin-left: auto; margin-right: auto; margin-top: 0px; position: relative" >
      <div class="texte_gris16px" id="mouchar_particulier2" style="font-size:16px;	font-family:Arial, Helvetica, sans-serif ;	color:#838383; margin:10px 0px;   border-top:1px solid #CCC; padding-top:5px; text-transform: uppercase" align="center">NOTIFICATION D'AFFECTATION DE DOSSIER &agrave; <br>
        <strong style="color: #e37b03"><?php echo $legestionnaire["nom"]." ".$legestionnaire["prenom"]?></strong></div>
      ...
      <div align="left" class="div_formulaire" style="margin: 0px; background-color:#F6F7F9; padding:10px 5px">
        <table width="100%" border="0" align="center">
          <tr>
            <td height="28" colspan="3" align="center" valign="middle" class="texte_gris12px" style="font-size:14px;	font-family: 'Open Sans', sans-serif;	color:#838383;">Ci-dessous, les informations relatives &agrave; la demande<span class="texte_gris_14px"> de cresco</span></td>
          </tr>
           <tr>
          ...
          <?php if($demandeur["telephone2"]!=""){?>
           ...
           <tr>
             <td height="30" colspan="3" align="left" valign="middle" style="font-size:16px;	font-family:Arial, Helvetica, sans-serif color:#000000; text-transform: uppercase"><span class="texte_gris12px" style="font-size:14px; font-family: 'Open Sans', sans-serif; color:#838383;">Affectation effectu&eacute;e par  <strong><?php echo $ladministrateur["nom"]." ".$ladministrateur["prenom"]?></strong></span></td>
            </tr>
          </table>
      </div>
