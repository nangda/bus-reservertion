	...
	<?php 
	 ...
	 ?>
				<tr id="tr_dossier<?php echo $demandeur[0]?>">															
					...
					<td><strong><?php echo utf8_decode($demandeur["nom"]." ".$demandeur["prenom"] );?></strong></td>
					...
					<td><?php if($agence!=false) echo "<strong>".utf8_decode($agence["titre"])."</strong>"; else echo "Pas encore renseign&eacute;e"?></td>
					<td><?php if($ville!=false) echo  "<strong>".utf8_decode($ville["titre"])."</strong>"; else echo "Pas encore renseign&eacute;e"?></td>
