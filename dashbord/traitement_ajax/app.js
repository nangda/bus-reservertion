			...
			//alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				    ...
				    $("#td-cloture-tout"+iddemandeur).addClass("cloture");
				    $("#td-couleur-tout"+iddemandeur).addClass(reponse.newclass);
				    if(reponse.oldclass!="")$("#td-couleur-tout"+iddemandeur).removeClass(reponse.oldclass);
			 ...
			 //alert(data);
			  var reponse = JSON.parse(data); 
			   if(reponse.erreur=="oui"){
				   ...
				   alert(reponse.nbreponse);
				   if(reponse.nbreponse==0)$("#"+conteneur_liste).html("AUCUN RESULTAT");
				   else {
					   alert("589");
					   $("#"+conteneur_liste).html(reponse.liste);alert("8910");
				   }
