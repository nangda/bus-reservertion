				...
				<div id="wrap-section-right">
					  <div id="section-right">
						  <div id="wrap-entete-page">
							  <h1 id="title-page">Gestion des ventes</h1>
							  <ul id="fil-arian">
						...
						<ul id="conteneur-onglet-page">
							<li class="onglet-page actif" data-id="tab-client">Les clients</li>
							 <li class="onglet-page " data-id="tab-historique-paiement">Historique de paiement</li>
						</ul>
						...
						<div id="wrap-content-right">
							...
							<div id="conteneur-page">
								...
								<?php include("includes/onglet-client.php"); ?>
								
								
								<!--			RUBRIQUE DE GESTION DES GENRES					-->
								<?php include("includes/onglet-historique-paiement.php"); ?>
