								<div class="wrap-contain-onglet-page" id="tab-client" style="display: block;">
									<div class="contain-onglet-page">
										<h2 class="titre-tab">Liste des clients</h2>
										...
										<div id="wrap-table-adhesion" class="conteneur-wrap-tab">
											...
											<div class="contain-tab2" id="tab-adhesion" style="display: block">
												...
												<div class="wrap-content-page">
													<p class="accroche-tab">Ci-dessous la liste des client de la plateforme.</p>
														<div class="conteneur-recherche-fiche">
														  <form action="" id="" class="formulaire-research form-recherche">
																...
																<div class="form-group search-wrapper">
																	<div class="libele-periode lib-periode">P&eacute;riode d'inscription</div>
															  ...
															  <div class="form-group">
															  	<label for="">Nom<input name="libelle-nom" type="text" class="search ref-search" id="libelle-nom" placeholder="Ex: Gilles" data-onglet="toute"></label>
															  </div>
													...
													<table id="liste-page">
														<thead>
															<tr>
																...
																<th>SOLDE</th>
																<th>E-mail</th>
																<th>T&eacute;l&eacute;phone compte</th>
																<th>T&eacute;l&eacute;phone paiement</th>
																<th>pays</th>
																<th>Vile</th>
														...
														<tbody id="tbody-client">
															<tr id="tr_client1">
																<td class="colonne-tab edit-line"><a href=""><i class="fa fa-pencil"></i></a></td>
																<td class="colonne-tab detail-line"><i class="fa fa-lock"></i></td>
																<td class="colonne-tab"><a href=""><i class="fa fa-check-circle"></i></a></td>
																<td class="colonne-tab delete-line"><a href=""><i class="fa fa-trash"></a></i></td>
																<td >Bilanda fouda Denis fr&eacute;dy</td>
																<td >2500</td>
																<td >pierrefarel55@gmail.com</td>
																<td >696304579</td>
																<td >696304579</td>
																<td >Cameroun</td>
																<td >Douala</td>
																<td >09/04/2016 à 20:02:25</td>
															</tr>
														</tbody>
													</table>
												</div>
