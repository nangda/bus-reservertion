														...
														<div class="conteneur-recherche-fiche">
														  <form action="" id="form-recherche-tous-dossiers" class="formulaire-research form-recherche">
															  ...
															  <div class="form-group">
															  	...
															  	<button type="button" class="btn-search valide-form-search" onClick="Rechercher('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-recherche-tous-dossiers','liste-tous-dossiers','loader')" id="btn-search-toutes"><i class="fa fa-search"></i></button>
