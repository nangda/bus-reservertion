								<div class="wrap-contain-onglet-page" id="tab-dossier-incomplet" <?php if(isset($_SESSION["onglet-suivi"]) AND $_SESSION["onglet-suivi"]=="tab-dossier-incomplet"){?>style="display: block"<?php }?>>
									...
									<div class="contain-onglet-page">
										...
										<h2 class="titre-tab">dossiers incomplets</h2>
 										<div id="wrap-table-adhesion" class="conteneur-wrap-tab">
 											<div class="contain-tab2" id="tab-adhesion" style="display: block">
 												...
 												<div class="wrap-content-page">
													...
													<p class="accroche-tab">Ci-dessous la liste des dossiers incomplets. les souscripteurs n'ont pas encore renseign&eacute; toutes les données réquises.</p>



														<div class="conteneur-recherche-fiche">

														  <form action="" id="form-dossier-incomplet" class="formulaire-research form-recherche">
															  ...
															  <div class="form-group">
 															  ...
 															  <div class="form-group">
 															  	<button type="button" class="btn-search valide-form-search" onClick="Rechercher('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-incomplet','liste-dossiers-incomplet','loader')"><i class="fa fa-search"></i></button>
															  	<input type="hidden" name="token" id="token" value="<?php echo $_SESSION["token"] ?>"/>
                                                                <input type="hidden" name="form" id="form" value="form-dossier-incomplet"/>
                                                                <input type="hidden" name="etat-dossier" id="etat-dossier" value="Incomplet"/>
                                                                <input type="hidden" name="conteneur-resultat" id="conteneur-resultat" value="liste-dossiers-incomplet"/>
 															  </div>
                                               ...
                                               <div id="liste-dossiers-incomplet">
												...
												<?php 
												  ...
												  $query_demandeur="SELECT * FROM demandeur WHERE corbeille='0' AND etat='Incomplet' ";
														...
														<div class="pagination">
															...
															<div class="wrapper-pagination-right">
																...
																<?php if ($nb_enregistrement>$page){ ?>
																    ...
																    ?>
																		<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-incomplet','liste-dossiers-incomplet','<? echo $i ?>','loader')" class="wrap-pagination <?php echo $active?>"><?php echo $i?></a> 
																	<?php }?>
																	<?php if($nbpage>$nbpage_affiche){?>
																<span class="void-pagination">...</span>
																   <?php }?>
																<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-incomplet','liste-dossiers-incomplet','<? echo $page_active+1 ?>','loader')" class="wrap-pagination"><i class="fa fa-angle-right"></i> </a>
																<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-incomplet','liste-dossiers-incomplet','<? echo $nbpage ?>','loader')" class="wrap-pagination">Fin</a>
																<?php }?>																
