								<div class="wrap-contain-onglet-page" id="tab-administrateur" <?php if((isset($_SESSION["onglet-utilisateur"]) AND $_SESSION["onglet-utilisateur"]=="tab-administrateur") OR !isset($_SESSION["onglet-utilisateur"])){?>style="display: block"<?php }?>>
														  ...
														  <form action="" id="form-recherche-administrateur" class="formulaire-research form-recherche">
															  ...
															  <div class="form-group">
																...
																<div class="form-group ">
																		...
																		<label for="">Agence d'affectation
																		<select name="agence" id="agence" data-error-contener="div-erreur-champ-agence" class="search ref-search ref-search-responsive" >

																			<option value="" desable selected>Sélectionner</option>
																...
																<div class="form-group ">
																		...
																		<label for="">Profil
																		  <select name="profil" id="profil" type="text" class="search ref-search ref-search-responsive">
																				<option value="" desable selected>Sélectionner</option>
																				<option value="Administrateur" >Administrateur</option>
																				<option value="Charge_daccueil">Chargé(e) d'accueil en agence</option>
																				<option value="Gestionnaire">Gestionnaire en agence</option>
																				<option value="Invite">Invit&eacute;</option>
																			</select>
																		</label>
															  ...
															  <div class="form-group">
																...
																<div class="form-group search-wrapper">
																	...
																	<div class="form-control">
																		<label for="">
																		  <select name="niveau_dacces" id="wrapper-hierachie-donnee-1" type="text" class="search ref-search ref-search-responsive" onChange="Select_cirsconscription_utilisateur('<?php echo base64_encode("traitement_ajax/main.php?traitement=select_cirsconscription_utilisateur")?>', '<?php echo $_SESSION["token"]?>')">
																		...
																		<label for=""> 
																			<select name="circonscription" id="wrapper-hierachie-donnee-2" type="text" class="search ref-search ref-search-responsive">
																				<option value="">----------</option>
														...
														<?php 
													      ...
													      ?>
															...
															<tr id="tr_administrateur<?php echo $administrateur[0]?>">
																...
																<td id="ville-administrateur<?php echo $administrateur[0]?>"><? echo $agence["titre"]; ?></td>
																...
																<td id="acces-administrateur<?php echo $administrateur[0]?>">
																	...
																	<?php echo getLibelleDroitAccesDossiers($administrateur[0]) ?> 	
																</td>
