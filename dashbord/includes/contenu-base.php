				...
				<div id="wrap-section-right">
					  <div id="section-right">
						...
						<ul id="conteneur-onglet-page">
							<li class="onglet-page <?php if((isset($_SESSION["onglet"]) AND $_SESSION["onglet"]=="tab-region") OR !isset($_SESSION["onglet"])){?>actif<?php }?>" data-id="tab-region">Les R&eacute;gions</li>
							 <li class="onglet-page <?php if(isset($_SESSION["onglet"]) AND $_SESSION["onglet"]=="tab-ville"){?>actif<?php }?>" data-id="tab-ville">Les Villes</li>
							 <li class="onglet-page <?php if(isset($_SESSION["onglet"]) AND $_SESSION["onglet"]=="tab-agence"){?>actif<?php }?>" data-id="tab-agence">Les Agences</li>
							 <li class="onglet-page <?php if(isset($_SESSION["onglet"]) AND $_SESSION["onglet"]=="tab-importation"){?>actif<?php }?>" data-id="tab-importation"> Importation des données</li>
						</ul>
						...
						<div id="wrap-content-right">
							...
							<div id="conteneur-page">
								...
								<!--			RUBRIQUE DE GESTION DES AGENCE					-->
								<?php include("includes/onglet-importation.php"); ?>
