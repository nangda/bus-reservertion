								<div class="wrap-contain-onglet-page" id="tab-album-photo">
									<div class="contain-onglet-page">
										<h2 class="titre-tab">Liste des albums photos</h2>

										<div id="wrap-table-album" class="conteneur-wrap-tab">

											<!--	CONTENU DE L'ONGLET DES PARTICIPANTS		-->
											<div class="contain-tab2" id="tab-album-photo" style="display: block">
												<h2 class="titre-page">
													<div class="wrap-btn-plus-tab">
														<a href="" class="btn-filter"><i class="fa fa-filter"></i>Filter</a>
															<a href="javascript:Affichage_contenuLightBox64('<?php echo base64_encode("lightbox/lightbox-ajouter-album-photo.php")?>','loader',initDatePaiement);" class="btn-add"><i class="fa fa-plus"></i>Ajouter un album</a>
													</div>
												</h2>

												<div class="wrap-content-page">
													<p class="accroche-tab">Ci-dessous la liste des albums photos.</p>
													...
													<table id="liste-page">
														<thead>
															<tr>
																...
																<th align="left">Date &agrave; afficher </th>
															</tr>
														</thead>
