								<div class="wrap-contain-onglet-page" id="tab-dossier-encours" <?php if(isset($_SESSION["onglet-suivi"]) AND $_SESSION["onglet-suivi"]=="tab-dossier-encours"){?>style="display: block"<?php }?>>
									...
									<div class="contain-onglet-page">
										...
										<h2 class="titre-tab">dossiers en cours de traitement. </h2>
										...
										<div id="wrap-table-adhesion" class="conteneur-wrap-tab">
 											<div class="contain-tab2" id="tab-adhesion" style="display: block">
 												...
 												<div class="wrap-content-page">
 													<p class="accroche-tab">Ci-dessous la liste des dossiers d&eacute;j&agrave; pris en charge, mais encore en cours de traitement.</p>
 														<div class="conteneur-recherche-fiche">
 														  <form action="" id="form-dossier-en-cours" class="formulaire-research form-recherche">
 																	...
 																	<label class="input-with-search-icon" for="">
 																		...
 																		<div class="slect-with-search-icon">
 																			...
 																			<option value="" desable selected>S&eacute;lectionnez</option>
																			  ...
																			  ?>
																			  <option value="<?php echo $agence[0]?>" data-code="<?php echo $agence["reference"]?>" ><?php echo $agence["titre"]?></option>
																			  <?php }?>
															  ...
															  <div class="form-group">
															  	...
															  	<button type="button" class="btn-search valide-form-search" onClick="Rechercher('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-en-cours','liste-dossiers-en-cours','loader')"><i class="fa fa-search"></i></button>
															  	 <input type="hidden" name="token" id="token" value="<?php echo $_SESSION["token"] ?>"/>
                                                                <input type="hidden" name="form" id="form" value="form-dossier-en-cours"/>
                                                                <input type="hidden" name="etat-dossier" id="etat-dossier" value="En_cours"/>
                                                                <input type="hidden" name="conteneur-resultat" id="conteneur-resultat" value="liste-dossiers-en-cours"/>
															  </div>
															</form>
 														</div>

                                               <div id="liste-dossiers-en-cours">
													...
													<table id="liste-page" class="liste-page" cellspacing="1">
 														<thead>
 															<tr style="text-align: left">
																...
																<?php if($profil!="Gestionnaire"){?><th></th><?php }?>
 																<?php if($droit_dacces["cloturer_demande"]==1){?><th></th><?php }?>
												...
												<?php 
												  ...
												  $query_demandeur="SELECT * FROM demandeur WHERE corbeille='0' AND etat='En_cours' ";
												  ...
												  while($demandeur=mysql_fetch_array($result_demandeur)){
													  ...
													  $clotureur= getadministrateurinformations($demandeur["cloture_par"]);
													        ...
													        $cloture=GetInfosClotureDossier($demandeur[0]);
													        
													        $url_cloturer=$cloture["url"];
													        $infobulle_cloturer=$cloture["infobulle"];
												 ...
												 ?>
															<tr id="tr_dossier<?php echo $demandeur[0]?>">															
																...
																<td class="colonne-tab fermeture-dossier" id="td-cloture-tout<?php echo $demandeur[0]?>"><a href="<?php echo $url_cloturer?>" data-tooltip="<?php echo $infobulle_cloturer?>"><i class="fa fa-hourglass-end"></i></a></td>
														...
														<div class="pagination">
															...
															<div class="wrapper-pagination-right">
																...
																<?php if ($nb_enregistrement>$page){ ?>
																    ...
																    ?>
																		<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-en-cours','liste-dossiers-en-cours','<? echo $i ?>','loader')" class="wrap-pagination <?php echo $active?>"><?php echo $i?></a> 
																	<?php }?>
																	<?php if($nbpage>$nbpage_affiche){?>
																<span class="void-pagination">...</span>
																   <?php }?>
																<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-en-cours','liste-dossiers-en-cours','<? echo $page_active+1 ?>','loader')" class="wrap-pagination"><i class="fa fa-angle-right"></i> </a>
																<a href="javascript:Pagination('<?php echo base64_encode("traitement_ajax/main.php?traitement=rechercher-dossiers")?>','form-dossier-en-cours','liste-dossiers-en-cours','<? echo $nbpage ?>','loader')" class="wrap-pagination">Fin</a>
																<?php }?>																
