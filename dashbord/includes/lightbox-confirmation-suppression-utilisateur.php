...
<body>
 ...
 <div class="conteneur-lightbox">
  <div class="lightbox" id="lightbox-confirmation-operation">
    <div class="entete-lightbox"> Suppression de l'opération.
  ...
  <div class="contenu-lightbox" id="conteneur-creation-compte">
    <div class="content-form">
		<p class="accroche-lightbox"> Pour supprimer cet utilisateur cliquez sur le bouton "Supprimer l'utilisateur".	</p>
      <form action="" id="form-confirmation-operation" class="form-confirmation-operation"> 
		  ...
		  <table class="wrap-content-detail-element">
			...
			<div class="ligne-form ligne-btn">
				...
				<input type="button" id="btn-valider" name="valider-form" class="btn-submit"  value="Supprimer l'utilisateur" onClick="<?php echo $url_supprimer?>">
				<input type="hidden" name="token" id="token" value="<?php echo $_SESSION["token"] ?>" />     
				<input type="hidden" name="" id="" value="<?php echo $idoperation ?>" />     
				<input type="hidden" name="" id="" value="<?php echo $latontine[0]?>"/>
			</div>		
