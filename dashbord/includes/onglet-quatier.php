								<div class="wrap-contain-onglet-page" id="tab-quartier">
									<div class="contain-onglet-page">
										...
										<a href="javascript:Affichage_contenuLightBox64('<?php echo base64_encode("lightbox/lightbox-ajouter-quartier.php")?>','loader',initDatePaiement);" class="btn-add"><i class="fa fa-plus"></i>Ajouter une commune</a>
										</h2>
													...
													<div class="conteneur-recherche-fiche">
														  <form action="" id="" class="formulaire-research form-recherche">
															  ...
															  <div class="form-group">
																	<div class="form-control">
																		<label for="">Quartiers
																			<select name="quatier" id="quartier" type="text" class="search ref-search ref-search-responsive">
