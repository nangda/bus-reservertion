                               <div class="wrap-contain-onglet-page" id="tab-ville" <?php if(isset($_SESSION["onglet"]) AND $_SESSION["onglet"]=="tab-ville"){?>style="display: block"<?php }?>>
									<div class="contain-onglet-page">
										<h2 class="titre-tab ">Edition  des villes</h2>
