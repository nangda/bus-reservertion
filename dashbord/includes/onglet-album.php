								<div class="wrap-contain-onglet-page" id="tab-album">
									<div class="contain-onglet-page">
										<h2 class="titre-tab">Liste des albums</h2>

										<div id="wrap-table-album" class="conteneur-wrap-tab">

											<!--	CONTENU DE L'ONGLET DES PARTICIPANTS		-->
											<div class="contain-tab2" id="tab-album" style="display: block">
												<h2 class="titre-page">
													<div class="wrap-btn-plus-tab">
														<a href="" class="btn-filter"><i class="fa fa-filter"></i>Filter</a>
															<a href="javascript:Affichage_contenuLightBox64('<?php echo base64_encode("lightbox/lightbox-ajouter-album.php")?>','loader',initDatePaiement);" class="btn-add"><i class="fa fa-plus"></i>Ajouter un album</a>
													</div>
												</h2>

												<div class="wrap-content-page">
													<p class="accroche-tab">Ci-dessous la liste des albums.</p>
														...
														<div class="conteneur-recherche-fiche">
														  <form action="" id="" class="formulaire-research form-recherche">
															  ...
															  <div class="form-group">
															  	<label for="">Nom album<input name="libelle-nom-a" type="text" class="search ref-search" id="libelle-nom-a" placeholder="Ex: Tenor" data-onglet="toute"></label>
															  </div>
													...
													<table id="liste-page">
														<thead>
															<tr>
																...
																<th align="left">Nbres titres </th>
																<th align="left">Ann&eacute;e</th>
																<th align="left">Genre </th>
																<th align="left">Prix</th>
																<th align="left">Metadonn&eacute;es</th>
															</tr>
														</thead>
														...
														<tbody id="tbody-membre">
															<tr id="tr_membre32">
																...
																<td align="left">Bryan Pitol</td>
																<td align="left">6</td>
																<td align="left">2002</td>
																<td align="left">RAP</td>
																<td align="left">1000</td>
																<td align="left"> Les m&eacute;tadonn&eacute;es
																	</td>
															</tr>
														</tbody>
													</table>
