<header>
		...
		<div id="wrap-super-header">
			...
			<div id="super-header">
				...
				<div class="super-header-right">
					...
					<a href="https://www.facebook.com/"><i class="fa fa-search"></i></a>

					<a href="javascript:Acceder_panier()">
				   ...
				   <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 33 33" style="enable-background:new 0 0 33 33;" xml:space="preserve">
					...
					<span class="nunber-elt-panier" id="nunber-elt-panier">0</span>

			   </a>

					<a href="https://www.google.plus.com/"><svg version="1.1" class="icone-user-call" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 316.824 316.824" style="enable-background:new 0 0 316.824 316.824;" xml:space="preserve">
			...
			C105.982,134.919,89.4,109.892,89.4,82.032C89.4,80.946,89.484,79.879,89.561,78.819z"></path>
					...
					<div class="btn-menu">Programme de garde</div>
		...
		<div id="wrap-header">
			...
			<div id="header">
				...
				<ul class="elt-contact-header">

					<li class="elt-header">

						<span class="icon-elt-menu"><img src="images/smartphone-call.png" alt=""></span>

						<div class="text-elt-header">

							<h4 class="libele-elt-header">Nous contacter</h4>

							<span> +237 233 433 729  / 699 876 474</span>
					...
					<li class="elt-header">
						...
						<span class="icon-elt-menu"><img src="images/placeholder.png" alt=""></span>

						<div class="text-elt-header">

							<h4 class="libele-elt-header">Localisation</h4>

							<span>Douala, Supermarch&eacute; Carrefour Bonamoussadi.</span></div>

					</li>

					<li class="elt-header">

						<span class="icon-elt-menu"><img src="images/schedule.png" alt=""></span>

						<div class="text-elt-header">

							<h4 class="libele-elt-header">Horaires</h4>

							<span>7h 00 - 20h 00</span>
				...
				<nav id="menu-wrap">
					...
					<ul id="menu">
						...
						<li ><a href="./">Premiers Soins</a></li>
                 		...
                 		<li ><a href="./">B&eacute;b&eacute;-Enfant</a></li>

                 		<li ><a href="./">Beaut&eacute; et corps</a></li>

                	 	<li ><a href="./">Soins dentaires</a></li>

<!--                	 	<li ><a href="./">Bio & Nature</a></li>-->
