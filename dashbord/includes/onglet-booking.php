                               <div class="wrap-contain-onglet-page" id="tab-booking" <?php if(isset($_SESSION["onglet"]) AND $_SESSION["onglet"]=="tab-booking"){?>style="display: block"<?php }?>>
									<div class="contain-onglet-page">
										<h2 class="titre-tab ">Update bookings</h2>
