				...
				<div class="content-form">
					...
					<form action="" id="form-ajout-departement" class="form-ajout" enctype="multipart/form-data">
						...
						<div class="ligne-form">
							...
							<select name="province-departement" id="province" data-error-contener="div-erreur-champ-province"  class="mandatory-departement">
								...
								<?php 
								 ...
								 ?>
								<option value="<?php echo $province[0]?>" <?php if($iddepartement!=0 AND $ledepartement["idprovince"]==$province[0])echo"SELECTED";?>><?php echo utf8_encode($province["titre"])?></option>
								<?php }?>
							</select>
