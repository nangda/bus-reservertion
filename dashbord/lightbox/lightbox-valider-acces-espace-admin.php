 ...
 <div class="conteneur-lightbox">
  ...
  <div class="contenu-lightbox" id="conteneur-code-lightbox">
    ...
    <div class="content-form">
      ...
      <p class="accroche-indicateur">Saisissez le code à 04 chiffres que nous venons de vous envoyer <br> par Mail <?php if($administrateur["telephone"]!=""){?>/SMS<?php }?>. </p>
		...
		<form action="" id="form-validation-code" onSubmit="return false">
						  ...
						  <div class="checkbox clearfix">
							  ...
							  <div class="wrap-decompte">J'ai n'ai pas reçu de SMS,
