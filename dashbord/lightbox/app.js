...
function Enregistrer_administrateur(traitement,idadministrateur){
   ...
   if (telephone!="" && !isCamerounNumber(telephone)) {
		$("#div-erreur-champ-telephone").fadeIn("slow");
		error = true;
	}	
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   if(reponse.nboperation==1 && idadministrateur==0){
				     ...
				     if(idadministrateur!=0){
						...
						$( "#acces-administrateur"+idadministrateur ).html( reponse.acces );
					 }else{
...
function Notification_suppression_administrateur(traitement, idadministrateur, token, deja_operation){
	...
	if(deja_operation==1){
		AfficherNotification("INFORMATION","loader2","Cet utilisayeur a d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer","OK","","","","0");
	}else{
			  ...
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
					  ...
					  if(reponse.session=="0"){
					      ...
					      var message="Cet utilisateur contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer";
...
function Select_cirsconscription(traitement, token){
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   if(reponse.nbregion==1 && idregion==0){
				     ...
				     if(idregion!=0){
						...
						$( "#zone-region"+idregion ).html( reponse.zone );
					 }else{
...
function Notification_suppression_region(traitement, idregion, token, deja_operation){
	...
	if(deja_operation==1){
		AfficherNotification("INFORMATION","loader2","Cette R&eacute;gion contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc la supprimer","OK","","","","0");
	}else{
			  ...
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
					  ...
					  if(reponse.session=="0"){
					      ...
					      var message="Cette R&eacute;gion contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc la supprimer";
					      AfficherNotification("INFORMATION","loader2",message,"OK","","","","0");
					  }
			   }else{
...
function Notification_suppression_departement(traitement, iddepartement, token, deja_operation){
	...
	if(deja_operation==1){
		AfficherNotification("INFORMATION","loader2","Ce D&eacute;partement contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer","OK","","","","0");
	}else{
			  ...
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
					  ...
					  if(reponse.session=="0"){
					      ...
					      var message="Ce D&eacute;partement contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer";
					      AfficherNotification("INFORMATION","loader2",message,"OK","","","","0");
					  }
			   }else{
...
function Notification_suppression_commune(traitement, idcommune, token, deja_operation){
	...
	if(deja_operation==1){
		AfficherNotification("INFORMATION","loader2","Cette commune contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer","OK","","","","0");
	}else{
			  ...
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
					  ...
					  if(reponse.session=="0"){
					      ...
					      var message="Cette commune contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer";
					      AfficherNotification("INFORMATION","loader2",message,"OK","","","","0");
					  }
			   }else{
...
function Notification_suppression_ville(traitement, idville, token, deja_operation){
	...
	if(deja_operation==1){
		AfficherNotification("INFORMATION","loader2","Cette ville contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer","OK","","","","0");
	}else{
			  ...
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
					  ...
					  if(reponse.session=="0"){
					      ...
					      var message="Cette ville contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer";
					      AfficherNotification("INFORMATION","loader2",message,"OK","","","","0");
					  }
			   }else{
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   if(reponse.nbagence==1 && idagence==0){
				     ...
				     if(idagence!=0){
						...
						$( "#zone-agence"+idagence ).html( reponse.zone );
					 }else{
...
function Notification_suppression_agence(traitement, idagence, token, deja_operation){
	
	if(deja_operation==1){
		AfficherNotification("INFORMATION","loader2","Cette Agence contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc la supprimer","OK","","","","0");
	}else{
		AfficherNotification("INFORMATION","loader2","Voulez vous d&eacute;finitivement supprimer cette ville ?","OUI","javascript:Supprimer_ville('"+traitement+"', '"+idagence+"', '"+token+"')","ANNULER","","0");
	}
	
}

function Supprimer_agence(traitement, idagence, token){
	

		var destination_traitement=base64_decode(traitement); 
		var data_to_send="idagence="+idagence+"&token="+token;
			  ...
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
					  ...
					  if(reponse.session=="0"){
					      ...
					      var message="Cette agence contient d&eacute;j&agrave; des enregistrements connexes,  vous ne pouvez donc le supprimer";
					      AfficherNotification("INFORMATION","loader2",message,"OK","","","","0");
					  }
			   }else{
				   if(reponse.nbagence=0){
					   AfficherNotification("INFORMATION","loader2","Suppression effectu&eacute;e avec succ&egrave;s.","OK","javascript:location.reload()","","","0");
				   }else{
						 AfficherNotification("INFORMATION","loader2","Suppression effectu&eacute;e avec succ&egrave;s.","OK","","","","0");
				   }
				   $( "#tr_agence"+idagence ).remove();
				} 
			},
					   ...
					   success : function(data, statut){ // success est toujours en place, bien sûr !
						   ...
						   if(reponse.erreur=="oui"){
							   ...
							   Cacher_loader("loader2")
									  ...
									  var message="Enregistrement effectu&eacute; avec succès. Mail et SMS de confirmation envoy&eacute;s &agrave; <strong>"+nom+" "+prenom+"</strong>";
									  AfficherNotification("INFORMATION","loader",message,"OK","","","","1");
			...
			//alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   AfficherNotification("INFORMATION","loader2","<b>F&eacute;licitations</b> <br />! Votre photo a &eacute;t&eacute; mise &agrave; jour avec succ&egrave;s","OK","javascript:location.reload()","","","0");
				} 
			},
			 ...
			 //alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   $("#"+element).find(".btn-search").trigger("click");
				} 
			},
...
function GotoOnglet(traitement, element, token){
			 ...
			 //alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
                    ...
                    self.location=$("base").attr("href")+"suivi-des-demandes/";
			   } 
			},
...
function Notification_enregistrer_cloture_dossier(traitement, LeDossierDemandeurEstIlComplet){
	...
	var onglet=$("li.actif").attr("data-id"); 
			...
			alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				    ...
				    $("#"+onglet).find( "#tr_dossier"+iddemandeur ).remove();
				    Cacher_loader("loader2");
				    AfficherNotification("INFORMATION","loader","Dossier cl&ocirc;tur&eacute; avec succ&egrave;s","OK","","","","1");
				} 
			},
...
function Modifier_telephone(traitement){
	
	var error=false; 
	$("#form-modifier-telephone .message-erreur ").fadeOut("slow");
	var telephone = trim($("#new-telephone-user").val());
	var confirm_telephone = trim($("#confirm-telephone-user").val());

	if (!isCamerounNumber(telephone)) {
		$("#div-erreur-champ-new-telephone-user").fadeIn("slow");
		error = true;
	}else 	if (telephone != confirm_telephone) {
		$("#div-erreur-champ-confirm-telephone-user").fadeIn("slow");
		error = true;
	}
	
	$( ".mandatory-telephone" ).each(function() {
		if(trim($(this).val())==""){
			var conteneur_erreur=$(this).attr("data-error-contener");
			$("#"+conteneur_erreur).fadeIn("slow");
			error=true;
	...
	if(error==false){
		var destination_traitement=base64_decode(traitement); 
		var data_to_send=$("#form-modifier-telephone").serialize();
...
function Valider_code_authentification_modif_telephone(traitement){
	...
	if(error==false){
		...
		var data_to_send=$("#form-validation-code").serialize()+"&telephone="+telephone;
			...
			//(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				    ...
				    AfficherNotification("INFORMATION","loader",reponse.message,"OK","javascript:location.reload()","","","0");
				    Cacher_loader("loader2");
				} 
			},
...
function Modifier_pwd(traitement){
	...
	var confirm_password = trim($("#confirm-pwd-user").val());
	...
	if (password != confirm_password) {
		$("#div-erreur-champ-confirm-pwd-user").fadeIn("slow");
		error = true;
	}
	...
	if(error==false){
		...
		var destination_traitement=base64_decode(traitement); 
		var data_to_send=$("#form-modifier-pwd").serialize();
...
function Enregistrer_importation(traitement){
	            $("#traitement-apercu").val("enregistrer-importation");
				var form=$(this).attr("data-form");
				var destination_traitement=base64_decode(traitement); 
				var myForm = document.getElementById("form-ajout-importation");
				var data_to_send=new FormData(myForm); 
				
	            $("#loader").html($("loader2").html());
	            Afficher_loader("loader2"); 
				$.ajax({
				   url : destination_traitement,
				   type : 'POST', // Le type de la requ&ecirc;te HTTP, ici devenu POST
					...
					//alert(data);
					  var reponse = JSON.parse(data); 
					   if(reponse.erreur=="oui"){
						   ...
						   if(reponse.nbligne>0) AfficherNotification("INFORMATION","loader",reponse.message,"OK","javascript:location.reload()","","","0");
						   else AfficherNotification("INFORMATION","loader",reponse.message,"OK","","","","1");
						   Cacher_loader("loader2");
...
function Apercu_importation(traitement){
				var form=$(this).attr("data-form");
				var destination_traitement=base64_decode(traitement); 
				var myForm = document.getElementById("form-ajout-importation");
				var data_to_send=new FormData(myForm); 
...
function Notification_suppression_importation(traitement, idimportation, token){
	
	
		AfficherNotification("CONFIRMATION","loader2","Voulez vous d&eacute;finitivement supprimer cet enregistrement ?","OUI","javascript:Supprimer_importation('"+traitement+"', '"+idimportation+"', '"+token+"')","ANNULER","","0");
	
}

function Supprimer_importation(traitement, idimportation, token){
	

		var destination_traitement=base64_decode(traitement); 
		var data_to_send="idimportation="+idimportation+"&token="+token;
			...
			//alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   $( "#tr_importation"+idimportation ).remove();
				} 
			},
...
function Valider_importation(traitement, idimportation, token, etat){
	

		var destination_traitement=base64_decode(traitement); 
		var data_to_send="traitement=valider-importation&idimportation="+idimportation+"&token="+token;
			...
			// alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				  ...
				  if(reponse.etat==1) $( "#valider-importation"+idimportation ).addClass("validated");
				  else $( "#valider-importation"+idimportation ).removeClass("validated");
				   Cacher_loader("loader2"); 
				} 
			},
...
function Dossier_en_pdf(element, fileName){
...
function GetVersionPdf(){
	$("#btn-version-pdf").click();
	Cacher_loader("loader");
}


function Enregistrer_affectation(traitement, iddemandeur){
	     
	    var onglet=$("li.actif").attr("data-id");
		  
		var destination_traitement=base64_decode(traitement); 
		var data_to_send=$("#form-affectation").serialize();
	    var error=false;
	    if (!$("input[name='gestionnaire']:checked").val()) error=true;
		...
		if(error==false){
				...
				//alert(data);
				  var reponse = JSON.parse(data); 
				   ...
				   if(reponse.erreur=="oui"){
					 ...
					 if(onglet=="tab-dossier-attente") $("#"+onglet).find( "#tr_dossier"+iddemandeur ).remove();
					  Cacher_loader("loader2"); 
					  AfficherNotification("INFORMATION","loader",reponse.message,"OK","","","","0");
					  $("#"+onglet).find("form").trigger("reset");
				      $("#"+onglet).find(".btn-search").trigger("click");
					} 
				},
			...
			AfficherNotification("INFORMATION","loader2","Veuillez indiquer le gestion &agrave; qui vous souhaitez affecter ce dossier","OK","","","","0");
		}	
...
function Notification_suppression_visite(traitement, idvisite, token){
	
		AfficherNotification("INFORMATION","loader2","Voulez vous d&eacute;finitivement supprimer cet enregistrement ?","OUI","javascript:Supprimer_visite('"+traitement+"', '"+idvisite+"', '"+token+"')","ANNULER","","0");
	
}

function Supprimer_visite(traitement, idvisite, token){
	

		var destination_traitement=base64_decode(traitement); 
		var data_to_send="idvisite="+idvisite+"&token="+token;
			...
			//alert(data);
			  var reponse = JSON.parse(data); 
			   ...
			   if(reponse.erreur=="oui"){
				   ...
				   if(reponse.nbvisite=0){
					   AfficherNotification("INFORMATION","loader2","Suppression effectu&eacute;e avec succ&egrave;s.","OK","javascript:location.reload()","","","0");
				   }else{
						 AfficherNotification("INFORMATION","loader2","Suppression effectu&eacute;e avec succ&egrave;s.","OK","","","","0");
				   }
				   var onglet=$("li.actif").attr("data-id"); 
				   if($("#"+onglet+" a.actif").click()){
					   console.log("element was clicked"); 
				   }else console.log("element was not clicked"); 
				   $( "#tr_visite"+idvisite ).remove();
				} 
			},
...
//*************************************DEVEROUILLAGE DOSSIER *********************************//

function Notification_enregistrer_deverouillage_dossier(traitement){
	var error=false;
	$("#form-deverrouillage .message-erreur ").fadeOut("slow");
	
		
	/*if ($('#form-deverrouillage:checkbox:checked').length==0) {
		AfficherNotification("CONFIRMATION","loader3","Vous devez selectionner au moins un champs.","OK","","","","1");	
		error = true;
	}*/
	
	if(error==false){
		AfficherNotification("CONFIRMATION","loader3","Vous &eacute;tes sur le point de deverouiller certain champs de se dossier pour que le client puisse faire des mises &agrave; jour, voulez vous continuer ?. ","OUI","javascript:Enregistrer_deverouillage_dossier('"+traitement+"')","ANNULER","","0");			
	}
	
}


function Enregistrer_deverouillage_dossier(traitement){
	...
	if(error==false){
		var destination_traitement=base64_decode(traitement); 
		var data_to_send=$("#form-deverrouillage").serialize(); 
