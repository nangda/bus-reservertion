					...
					<form action="" id="form-ajout-album" class="form-ajout" enctype="multipart/form-data">
						...
						<div class="ligne-form">
							...
							<div class="wrap-field-form middle">
								...
								data-error-contener="div-erreur-champ-annee-sortie" onKeyup="Verif_saisie(event, 'annee-sortie', 'btn-valider-album')" class="mandatory-album" <?php if($idalbum!=0){?>value="<?php echo utf8_encode($lalbum["annee-sortie"])?>"<?php }?>>
							...
							<div class="wrap-field-form middle">
								...
								data-error-contener="div-erreur-champ-nb-titre" onKeyup="Verif_saisie(event, 'annee-sortie', 'btn-valider-album')" class="mandatory-album" <?php if($idalbum!=0){?>value="<?php echo utf8_encode($lalbum["nb-titre"])?>"<?php }?>>
						...
						<div class="ligne-form">
							...
							<div class="wrap-field-form middle">
								...
								data-error-contener="div-erreur-champ-prix" onKeyup="Verif_saisie(event, 'prix', 'btn-valider-album')" class="mandatory-album" <?php if($idalbum!=0){?>value="<?php echo utf8_encode($lalbum["prix"])?>"<?php }?>>
								<span id="libelle_reference">Prix album <i class="">*</i></span>
