...
<body>
 ...
 <div class="conteneur-lightbox">
  <div class="lightbox" id="lightbox-confirmation-operation">
    <div class="entete-lightbox"> Suspendre l'utilisateur.
  ...
  <div class="contenu-lightbox" id="conteneur-creation-compte">
    <div class="content-form">
		<p class="accroche-lightbox"> Pour annuler la validation de cette opération, cliquez sur le bouton "Suspendre l'utilisateur".	</p>
      <form action="" id="form-confirmation-operation" class="form-confirmation-operation"> 
		  ...
		  <table class="wrap-content-detail-element">
			...
			<div class="ligne-form ligne-btn">
				...
				<input type="button" id="btn-valider-operation" name="valider-form" class="btn-submit"  value="Suspendre l'utilisateur" onClick="Validation_operation('<?php echo base64_encode('traitement_ajax/traitement_validation_operation.php')?>', '<?php echo '' ?>')">
