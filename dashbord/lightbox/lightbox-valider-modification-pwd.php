      ...
      <p class="accroche-indicateur">Saisissez le code à 04 chiffres que nous venons de vous envoyer par SMS. </p>
		...
		<form action="" id="form-validation-code" onSubmit="return false">
						  ...
						  <div class="form-group">
							  ...
							  <button type="button" class="btn btn-connexion" id="btn-valider-code" onclick="Valider_code_authentification_modif_pwd('<?php echo base64_encode('traitement_ajax/main.php')?>')">Valider</button>
							...
							<input type="hidden" name="traitement" id="traitement" value="valider-code-modification-pwd"/>
