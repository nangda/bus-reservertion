					...
					<form action="" id="form-ajout-agence" class="form-ajout" enctype="multipart/form-data">
						...
						<div class="ligne-form">
							<div class="wrap-field-form middle wrap-select">
								...
								<?php 
								 ...
								 ?>
								<option value="<?php echo $region[0]?>" <?php if($idagence!=0 AND $laagence["idregion"]==$region[0])echo"SELECTED";?>><?php echo ($region["titre"])?></option>
								<?php }?>
								</select>
							...
							<div class="wrap-field-form middle wrap-select">
								...
								<?php 
								 ...
								 ?>
									<option value="<?php echo $ville[0]?>" <?php if($idagence!=0 AND $laagence["idville"]==$ville[0])echo"SELECTED";?>><?php echo ($ville["titre"])?></option>
									<?php }?>
								<?php }?>
								</select>
						...
						<div class="ligne-form">
							<div class="wrap-field-form middle">
								...
								data-error-contener="div-erreur-champ-titre-agence" onKeyup="Verif_saisie(event, 'titre-agence', 'btn-valider-agence')" class="mandatory-agence" <?php if($idagence!=0){?>value="<?php echo ($laagence["titre"])?>" <?php }?>>
							...
							<div class="wrap-field-form middle">
								<input placeholder=" " type="text" name="reference-agence" id="reference-agence" <?php if($idagence!=0){?>value="<?php echo ($laagence["reference"])?>" <?php }?> data-error-contener="div-erreur-champ-reference-agence" onKeyup="Verif_saisie(event, 'reference-agence', 'btn-valider-agence')" class="mandatory-agence">
						...
						<div class="ligne-form">
							<div class="wrap-field-form middle">
								...
								data-error-contener="div-erreur-champ-telephone-agence" onKeyup="Verif_saisie(event, 'titre-telephone', 'btn-valider-agence')"  <?php if($idagence!=0){?>value="<?php echo ($laagence["telephone"])?>" <?php }?>>
								<span id="libelle_reference">T&eacute;l&eacute;phone <i class="">*</i></span>
								<div id="div-erreur-champ-telephone-agence" class="message-erreur">
									Veuillez indiquer le t&eacute;l&eacute;phone de l'agence.
								</div>
							</div>
							<div class="wrap-field-form middle">
								<input placeholder=" " type="text" name="email-agence" id="email-agence" <?php if($idagence!=0){?>value="<?php echo ($laagence["email"])?>" <?php }?> data-error-contener="div-erreur-champ-email-agence" onKeyup="Verif_saisie(event, 'email-agence', 'btn-valider-agence')" class="mandatory-agence">
