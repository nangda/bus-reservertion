...
if($error==""){ 
	 ...
	 $sms="<#>Code d'Authentification pour accès à la console d'administration BICEC CRESCO : $code_activation";
	 ...
	 mail_simple($administrateur["email"], "CODE D'ACCES A LA CONSOLE D'ADMINISTRATION" ,$tableau_mail_admin, "BICEC CRESCO<bicec@bicec.com>");   
